...
public class ExcelUtility
{
	...
	public void setCellData (String sheetName, int rowNumber, int columnNumber, String data) throws IOException
	{
		...
		if (workbook.getSheetIndex(sheetName) == -1)  // If sheet doesn't exist, a new one will be created.
			workbook.createSheet(sheetName);
			sheet = workbook.getSheet(sheetName);

		if (sheet.getRow(rowNumber) == null)  // If row doesn't exist, a new one will be created.
